...
def train(cfg,hp_cfg):
    ...
    train_split = load_dataset("csv", data_files=f"/home/leandre/Projects/BioMoQA_Playground/data/IPBES/folds/train{cfg['fold']}_run-{cfg['run']}.csv",split="train")
    dev_split = load_dataset("csv", data_files=f"/home/leandre/Projects/BioMoQA_Playground/data/IPBES/folds/dev{cfg['fold']}_run-{cfg['run']}.csv",split="train")
    test_split = load_dataset("csv", data_files=f"/home/leandre/Projects/BioMoQA_Playground/data/IPBES/folds/test{cfg['fold']}_run-{cfg['run']}.csv",split="train")
    ...
    final_model_path = os.path.join("/home/leandre/Projects/BioMoQA_Playground/results/ipbes/final_model", "best_model_cross_val_"+str(cfg['loss_type'])+"_" +str(map_name(cfg['model_name'])) + "_fold-"+str(cfg['fold']+1))
    ...
    result_metrics_path="/home/leandre/Projects/BioMoQA_Playground/results/ipbes/metrics/binary_metrics.csv"
    ...
    test_preds_path=os.path.join("/home/leandre/Projects/BioMoQA_Playground/results/ipbes/test preds/bert",f"fold_{cfg['fold']}_{map_name(os.path.basename(cfg['model_name']))}_{cfg['loss_type']}{'_with_title' if cfg['with_title'] else ''}{'_with_keywords' if cfg['with_keywords'] else ''}_run-{cfg['run']}_opt_neg-{cfg['nb_optional_negs']}.csv")
