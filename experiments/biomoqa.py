...
def main():
    ...
    pipeline=TrainPipeline(None,ensemble=args.ensemble,with_title=args.title,with_keywords=args.keywords,n_folds=2,n_trials=1,num_runs=1,model_names=["dmis-lab/biobert-v1.1", "google-bert/bert-base-uncased"])
